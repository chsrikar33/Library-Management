...
th, td {
  background-color: #96D4D4;
    ...
    <title>View User Available Books</title>
        ...
        <ul class="navbar-nav collapse navbar-collapse justify-content-end" id="navbarTogglerDemo01">
          <li class="nav-item"><a class="nav-link" href="./viewBooks">View Books</a></li>
           <li class="nav-item"><a class="nav-link " href="./alert">Alert</a></li>
			<li class="nav-item"><a class="nav-link active" href="./available">Available</a></li>
			<li class="nav-item"><a class="nav-link" href="/logout">Logout</a></li>
        </ul>
    </nav>
    <div class="container">
        <h3 style="text-align: center; margin: 50px 0px;" class="text-white">View User Available Books</h3>
