...
<body>
        ...
        <ul class="navbar-nav collapse navbar-collapse justify-content-end" id="navbarTogglerDemo01">
			...
			<li class="nav-item"><a class="nav-link active" href="./alert">Alert</a></li>
			<li class="nav-item"><a class="nav-link" href="/logout">Logout</a></li>
        </ul>
    </nav>
    <div class="container">
        <h3 style="text-align: center; margin: 50px 0px;" class="text-white">Admin Alert</h3>
         <p class="text-warning">${alertMessage}</p>
		...
		<div>
		 <table style="width:70%">
            ...
            <div>
                <c:forEach items="${alertBookList}" var="book">
          	<tr>
          		<td>${book.bookId}</td>
          		<td>${book.bookName}</td>
          		<td>${book.userId}</td>	
