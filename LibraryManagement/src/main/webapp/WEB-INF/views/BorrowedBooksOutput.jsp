...
th, td {
  background-color: #96D4D4;
    ...
    <title>Borrowed Books Output</title>
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <ul class="navbar-nav collapse navbar-collapse justify-content-end" id="navbarTogglerDemo01">
			...
			<li class="nav-item"><a class="nav-link active" href="./borrowedBooks">BorrowedBooks</a></li>
			<li class="nav-item"><a class="nav-link " href="./alert">Alert</a></li>
			<li class="nav-item"><a class="nav-link" href="/logout">Logout</a></li>
        </ul>
    </nav>
    <div class="container">
        <h3 style="text-align: center; margin: 50px 0px;" class="text-white">Borrowed Books</h3>
       <table style="width:50%">
        	  <tr>
    			<th>BookId</th>
    			<th>BookName</th>
    			<th>UserId</th>
    			<th>BookReturnDate</th>
  			</tr>
